package com.ophis.beantranslater.commonsqlmapper.handler;
...
public class CommonSqlParamHandler implements ParameterHandler
{
	...
	public CommonSqlParamHandler(MappedStatement mappedStatement, Object parameter, BoundSql boundSql) {
	...
	public Object processParameter(Object parameter)
	{
		...
		{
			// 检查 parameterObject
			if (ReflectionKit.isPrimitiveOrWrapper(parameter.getClass()) || parameter.getClass() == String.class)
			{
				return parameter;
			}
...
//			if(tableInfo==null)
//			{
//				tableInfo= TableInfoMaker.getTempTableInfo(configuration, parameter.getClass());
//				if(tableInfo!=null)
//				{
...
//			}
	...
	protected void populateKeys(TableInfo tableInfo, MetaObject metaObject, Object entity)
	{
		...
		{
			final IdentifierGenerator identifierGenerator = GlobalConfigUtils.getGlobalConfig(this.configuration)
